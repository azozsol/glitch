...
export const fr: Dictionary = {
    ...
    footer: {
        ...
        colServices: {
            title: "Services",
            items: ["Stratégie & créa", "Marketing digital", "Web & développement", "Identité visuelle", "Formation"],
        },
        colAgency: {
            title: "Agence",
            items: ["À propos", "Réalisations", "Blog", "Pourquoi GLITCH", "Offres & tarifs"],
        },
        colContact: {
            title: "Contact",
    ...
    home: {
        ...
        ticker: [
            ...
            "Identité visuelle", "Spots TV & Production", "SEO & Croissance", "Formation & Conseil",
            "Menus animés", "Design packaging",
        ],
        clients: {
        ...
        members: [
            {
                ...
                tags: [["DDB · BBDO · JWT", ""], ["35+ spots TV", "a"], ["CF2M · Bruxelles", ""]],
            },
            {
    ...
    contactForm: {
        ...
        fields: {
            ...
            budgetOptions: ["Moins de 1 500 €", "1 500 € – 5 000 €", "5 000 € – 15 000 €", "15 000 €+", "À définir ensemble"],
